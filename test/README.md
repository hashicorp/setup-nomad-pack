...
```
nomad-pack run self-test --var message="Hola Mundo!"
```
...
balance the Consul service `self-test-service`, which is the default value
...
- `consul_service_name` (string) - The consul service name for the self-test
  application
