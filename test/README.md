...
```
nomad-pack run test --var message="Hola Mundo!"
```
...
- `register_service` (bool: true) - If you want to register a Nomad service
  for the job
- `service_tags` (list of string) - The service tags for the test application
- `service_name` (string) - The service name for the test application
